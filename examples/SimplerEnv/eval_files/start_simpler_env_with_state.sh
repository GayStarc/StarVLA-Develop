...
if [ -n "$1" ]; then
  ...
  MODEL_PATH=/mnt/cpfs/guchenyang/Code/starVLA/playground/SimplerEnv/0202_Qwen3PI_bridgev2_chunk_16/checkpoints/steps_20000_pytorch_model.pt
fi
...
if [ -n "$3" ]; then
  ...
  video_dir_name="0202_Qwen3PI_Bridge_16_state/test"
fi
