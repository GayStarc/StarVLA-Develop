...
run_root_dir=./playground/R1LITE
run_id=0223_Qwen3_4B_PI_R1LITE_0215_Hand_Pretrain
...
accelerate launch \
  ...
  --config_yaml ./starVLA/config/training/qwen/qwen3-4b-pi-r1lite-hand-pretrain.yaml \
