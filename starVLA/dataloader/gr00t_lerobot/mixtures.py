...
DATASET_NAMED_MIXTURES = { 
    ...
    "libero_spatial_one_shot": [
        ("libero_spatial_one_shot_v2.1", 1.0, "libero_franka"),
    ],
    "r1lite_mix": [
        ("Merge/0213_pick_banana_robot_in_hand_in_hand_out", 1.0, "r1lite"),
    ],
    "r1lite_mix_0215": [
        ("Merge/0215_pick_banana_robot_in_hand_in_hand_out", 1.0, "r1lite"),
    ],
    "r1lite_robot": [
        ("Robot/0210_pick_banana_robot_in_domain", 1.0, "r1lite"),
    ],
    "r1lite_mix_in": [
        ("Merge/0210_pick_banana_robot_in_hand_in", 1.0, "r1lite"),
    ],
    "r1lite_mix_out": [
        ("Merge/0210_pick_banana_robot_in_hand_out", 1.0, "r1lite"),
    ],
    "robotwin_joint_absolute": [
        ("Easy_10_Tasks_Joint_Absolute/merged_lerobot", 1.0, "robotwin_joint"),
    ],
    "robotwin_joint_delta": [
        ("Easy_All_Tasks_Joint_Delta/merged_lerobot", 1.0, "robotwin_joint"),
    ],
    "robotwin_pose_absolute": [
        ("All_Tasks_EE_Quat_Absolute/merged_lerobot", 1.0, "robotwin_aloha"),
    ],
    "robotwin_pose_delta": [
        ("All_Tasks_EE_Quat/merged_lerobot", 1.0, "robotwin_aloha"),
    ],
    "bridge_v2": [
        ("bridge_v2_lerobot", 1.0, "widowx_v2"),
    ],
    "bridge_orig": [
        ("bridge_orig_lerobot", 1.0, "widowx"),
    ],
    "bridge_orig_v21": [
        ("bridge_orig_lerobot_v21", 1.0, "widowx_orig_padded14"),
    ],
    "custom_dataset": [
    ...
    "libero_all": [
        ("libero_object_no_noops_1.0.0_lerobot_v3.0", 1.0, "libero_franka"),
        ("libero_goal_no_noops_1.0.0_lerobot_v3.0", 1.0, "libero_franka"),
        ("libero_spatial_no_noops_1.0.0_lerobot_v3.0", 1.0, "libero_franka"),
        ("libero_10_no_noops_1.0.0_lerobot_v3.0", 1.0, "libero_franka"),
    ...
    "hand_euler_bridge_v2_pretrain": [
        ("Hand-Data/Pretrain-0207-Clean-Merged-Euler-Clean", 1.0, "hand_pretrain_euler"),
        ("Bridge/bridge_v2_lerobot", 1.0, "widowx_v2_padded14"),
    ],

    "hand_euler_bridge_orig_pretrain": [
        ("Hand-Data/Pretrain-0301-10k", 1.0, "hand_pretrain_euler"),
        ("Bridge/bridge_orig_lerobot_v21", 1.0, "widowx_orig_padded14"),
    ],
}
