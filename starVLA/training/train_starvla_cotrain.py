...
def prepare_data(cfg, accelerator, output_dir) -> Tuple[DataLoader, DataLoader]:
    ...
    return vla_train_dataloader, vlm_train_dataloader, val_dataloader
...
class VLAMTrainer(TrainerUtils):
    def __init__(self, cfg, model, vla_train_dataloader, vlm_train_dataloader, val_dataloader, optimizer, lr_scheduler, accelerator):
        self.config = cfg
        self.model = model
...
def main(cfg) -> None:
    ...
    # prepare data
    vla_train_dataloader, vlm_train_dataloader, val_dataloader = prepare_data(cfg=cfg, accelerator=accelerator, output_dir=output_dir)
